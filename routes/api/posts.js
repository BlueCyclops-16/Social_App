...
router.delete('/:id', auth, async (req, res) => {
    ...
    try {
        ...
        if (post.user.toString() !== req.user.id) { // here post.user is an Object id it is not a string
...
router.delete('/comment/:id/:comment_id', auth, async (req, res) => {
    try {
        ...
        // Check User deleting the comment is the user that has written that comment
